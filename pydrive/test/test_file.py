...
class GoogleDriveFileTest(unittest.TestCase):
    ...
    def test_05_Files_Insert_Content_File(self):
        ...
        self.assertEqual(filecmp.cmp(self.first_file,
                                     self.first_file+'1'), True)
        # Download file from id
        file2 = drive.CreateFile({'id': file1['id']})
        file2.GetContentFile(self.first_file+'2')
        self.assertEqual(filecmp.cmp(self.first_file,
                                     self.first_file+'2'), True)
    ...
    def test_09_Files_Update_File(self):
        ...
        self.assertEqual(filecmp.cmp(self.second_file,
                                     self.second_file+'1'), True)
