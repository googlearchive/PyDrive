...
class GoogleDrive(ApiAttributeMixin, object):
    ...
    def CreateFile(self, metadata=None):
        ...
        :type metadata: dict.
        :returns: pydrive.files.GoogleDriveFile -- initialized with auth of
                  this instance.
        """
        return GoogleDriveFile(auth=self.auth, metadata=metadata)

    def ListFile(self, param=None):
        """Create an instance of GoogleDriveFileList with auth of
           this instance.
        ...
        :type param: dict.
        :returns: pydrive.files.GoogleDriveFileList -- initialized with auth of
                  this instance.
        """
